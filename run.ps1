...
$env:PATH = "C:\Users\Athul\AppData\Local\Programs\nodejs;" + $env:PATH
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd frontend; npm run preview -- --port 3000 --host 127.0.0.1"
